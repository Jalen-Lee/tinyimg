export const SETTINGS_FILE_NAME = 'PicSharp.config.json'
...
export const SettingsKey = {
  'settings.compression.task_config.tinypng.api_keys': 'settings.compression.task_config.tinypng.api_keys',
